...
window.addEventListener("load", async () => {
    ...
    $('#cardTokenList').append('<a href="#" style="text-decoration:none" onclick="moreTokens()"><span style=color:#f1b632><span style=font-size:20px;font-weight:500;>' + $('#tokensListCardLabel').val() + ':</span></a>')
    ...
    function getTokenList() {
        if ($("#networkName").val() === 'mainnet') {
            ...
            $('#cardTokenList').html('');
            $('#cardTokenList').append('<a href=# style="text-decoration:none" onclick="moreTokens()"><span style=color:#f1b632;font-size:20px;font-weight:500;>' + $('#tokensListCardLabel').val() + ':</span></a>')
        ...
        $.getJSON('/getTransactions/?address=' + window.address + '&network=' + $('#networkName').val())
            .done(function (transactionsdata) {
                ...
                if (transactionsdata['status'] == 0) {
                    ...
                    $('#cardTxList').append('<a href=# style="text-decoration:none"><span style=color:#f1b632><span style=font-size:20px;font-weight:500;>' + $('#txListCardLabel').val() + ':</span></a>')
                    ...
                    for (let transaction of transactionsdata.result) {
                        ...
                        if (!txarr.includes(transaction['hash'])) {
                            ...
                            if (txC < 6) {
                                ...
                                if (txC == 0) {
                                    $('#cardTxList').append('<a href=# style="text-decoration:none" onclick="moreTransactions()"><span style=color:#f1b632><span style=font-size:20px;font-weight:500;>' + $('#txListCardLabel').val() + ':</span></a>')
                                    ...
                                    $('#cardTxList').append('<a class="tx-more-link" href="#" style="text-decoration:none" onclick="moreTransactions()"><span style=color:#f1b632>' + $('#txListCardLabelMore').val() + '</span></a>');
